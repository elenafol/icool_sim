...
def run_icool_sheet_mdl(param):
    with open("./for018_tempplate_sheet_model", 'r') as template:
        template_str = template.read()
    t = Template(template_str)
    content_to_run = t.substitute(HF_RADIUS = str(param[0]))
...
if __name__ == '__main__':
    # sigma_xy, sigma_px_py, beta_init = define_beam(emit_n=300*1e-06, pz_init=0.135, b_sol=31.2)
    # jhjh
